# Delta: Source Annotations

**Change ID:** `add-source-annotations`
**Affects:** source browser, project API, SQLite persistence, frontend state

---

## ADDED

### Requirement: Project-Scoped Source Annotations
...
### Requirement: Annotation Retrieval
...
### Requirement: Annotation Updates
...
### Requirement: Source Browser Annotation UI
...
### Requirement: Async Context Safety
...
### Requirement: Source File Preview
